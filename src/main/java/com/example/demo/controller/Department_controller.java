...
import com.example.demo.service.Depart_service_impl;
...
public class Department_controller {
    ...
    public DepartmentPojo getAdepartment(@PathVariable("did") long deptid){
       ...
       List<employeepojo> allemp= restClient.get().uri("http://employee-sr:8082/employees/dept/"+deptid).retrieve().body(List.class);
